...
```
$ docker image tag invoice docker.pkg.github.com/Morsi84/kubernetes/invoice
$ docker push docker.pkg.github.com/Morsi84/kubernetes/invoice
$ docker image tag notification docker.pkg.github.com/Morsi84/kubernetes/notification
$ docker push docker.pkg.github.com/Morsi84/kubernetes/notification
$ docker image tag store docker.pkg.github.com/Morsi84/kubernetes/store
$ docker push docker.pkg.github.com/Morsi84/kubernetes/store
```
